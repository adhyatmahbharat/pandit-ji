            ...
            <Card>
              <CardContent>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid size={{ md: 12, xs: 12 }}>
                    <Stack gap={1}>
                      <Typography variant="overline" color="text.primary" htmlFor="razorpay-key-secret" component="label">
                  ...
                  <Grid size={{ md: 12, xs: 12 }}>
                    <Stack gap={1}>
                      <Typography variant="overline" color="text.primary" htmlFor="razorpay-webhook-secret" component="label">
